...
public class TravelApp {
    ...
    public TravelApp() {
        ...
        menu = new MenuItem[]{
                ...
                new MenuItem("페이지목록", service::printTravelsByPage), new MenuItem("권역별목록", service::printTravelsByDistrict), new MenuItem("상세보기", service::printTravel),
    ...
    public int getMenuIndex() {
        System.out.print("선택: ");
        String line = sc.nextLine(); int ix = Integer.parseInt(line) - 1; return ix;
    }
